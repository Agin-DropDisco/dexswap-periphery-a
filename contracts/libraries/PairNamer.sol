...
// produces names for pairs of tokens using DEXswap's naming scheme
library PairNamer {
    string private constant TOKEN_PAIR_PREFIX = 'DEXS';
    ...
    // produces a pair symbol in the format of `DEXS:${symbol0}:${symbol1}${suffix}`
